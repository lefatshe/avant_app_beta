(function ($, window, document, undefined) {
  ...
  var Tiny = function(container, options){
    ...
    this.drawNavigator = function() {
      ...
      var output = "<footer class='footer'> <div class='footer__controls'> <div class='next_link'>  <button><span data-hover='Next'>Next</span></button> </div> <div class='pagination'><ul>\n";
