(function ($, window, document, undefined) {
  ...
  var Tiny = function(container, options){
    ...
    this.drawNavigator = function() {
      ...
      var output = "<footer class='footer'> <div class='footer__controls'> <div class='next_link'>  <a href='http://live.skybookings.net/events/connecting-the-dots-dj-spinna-nyc/'><img src='img/AG logo_FINAL.png' class='mobile-logo d-block d-sm-none' width='220px'><span data-hover='ONLINE'>BOOKING </span></a> </div> <div class='pagination'><ul>\n";
